...
## 12. Работа с удалёными репозиториями
...
Начнём с создания своего репозитория. Если у вас его ещё нет, то создайте по инструкции выше (можно пропустить), если есть, то создайте репозиторий на [GitHub](github.com) (в правом верхнем углу знчок +). Для начинающих программистов на следующей странице достаточно лишь написать имя репозитория:
